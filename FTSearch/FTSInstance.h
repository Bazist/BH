...
private:
	...
	void initAlphabet()
	{
		...
		while (true)
		{
			...
			{
				if (c == (uchar8)'ё' || c == (uchar8)'Ё') //convert to "e"
				{
					alphabet[c] = (uchar8)'е';
				}
				else if ((uchar8)'а' <= c && c <= (uchar8)'я') //lower case
				{
					alphabet[c] = c;
				}
				else if ((uchar8)'А' <= c && c <= (uchar8)'Я') //upper case
				{
					alphabet[c] = c + 32;
				}

				if (c == (uchar8)'й' || c == (uchar8)'Й') //convert to "e"
				{
					alphabet[c] = (uchar8)'и';
				}
			}
			...
			{
				if (c == (uchar8)'і' || c == (uchar8)'І') //convert to "e"
				{
					alphabet[c] = (uchar8)'і';
				}

				if (c == (uchar8)'ї' || c == (uchar8)'Ї') //convert to "e"
				{
					alphabet[c] = (uchar8)'ї';
				}

				if (c == (uchar8)'є' || c == (uchar8)'Є') //convert to "e"
				{
					alphabet[c] = (uchar8)'є';
				}
			}

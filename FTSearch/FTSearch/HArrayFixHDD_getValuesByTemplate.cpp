...
void HArrayFixHDD::getValuesByTemplateFromBlock(ulong64* values,
											uint32& count,
											uint32 size,
...
void HArrayFixHDD::getValuesByTemplate(ulong64* values,
									uint32& count,
									uint32 size,
									uint32 keyOffset, 
									uint32 contentOffset,
...
uint32 HArrayFixHDD::getValuesByTemplate(ulong64* values,
									uint32 size, 
									uint32* minKey, 
									uint32* maxKey)
{
